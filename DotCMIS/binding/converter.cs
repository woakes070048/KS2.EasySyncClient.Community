...
namespace DotCMIS.Binding
{
    internal class Converter
    {
        ...
        public static IContentStream Convert(cmisContentStreamType contentStream)
        {
            ...
            result.Stream = new System.IO.MemoryStream(contentStream.stream);
        ...
        public static cmisContentStreamType Convert(IContentStream contentStream)
        {
            ...
            {
                if (contentStream.Stream is System.IO.MemoryStream)
                {
                    result.stream = ((System.IO.MemoryStream)contentStream.Stream).ToArray();
                }
                else
                {
