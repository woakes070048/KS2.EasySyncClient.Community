...
namespace DotCMIS.Exceptions
{
    ...
    [Serializable]
    public class CmisUnauthorizedAccessException : CmisBaseException
    {
        public CmisUnauthorizedAccessException() : base() { }
        public CmisUnauthorizedAccessException(string message) : base(message) { }
        public CmisUnauthorizedAccessException(string message, Exception inner) : base(message, inner) { }
        protected CmisUnauthorizedAccessException(
          System.Runtime.Serialization.SerializationInfo info,
          System.Runtime.Serialization.StreamingContext context)
            : base(info, context) { }
        public CmisUnauthorizedAccessException(string message, long? code)
            : base(message) { }
        public CmisUnauthorizedAccessException(string message, string errorContent)
            : base(message) { }
        public CmisUnauthorizedAccessException(string message, string errorContent, Exception inner)
            : base(message, errorContent, inner) { }
    }
}
